...
public class ViewMarketPostActivity extends ActionBarActivity {
        ...
        thisTutorButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Notification note = new Notification(ParseUser.getCurrentUser().getObjectId(),
                        replyOwner,Notification.notificationType.SELECTED, marketPost.getPostId());
    ...
    public void getReplies(){
        ...
        query.whereEqualTo("postId", marketPost.getPostId());
    ...
    public void replyAction(View button){
        ...
        Notification note = new Notification(currentUser.getObjectId(), marketPost.getUser(),
                Notification.notificationType.REPLY, marketPost.getPostId());
        note.saveInBackground(new SaveCallback() {
            public void done(ParseException e) {
                if (e != null) {
                    System.out.println(e.getMessage());
...
*/
        ...
        ParseQuery query=new ParseQuery("MarketPost");
        query.whereEqualTo("objectId", intent.getStringExtra("post_id"));

        try {
            marketPost = (MarketPost)query.getFirst();
        }
        catch (com.parse.ParseException e) {
            e.printStackTrace();
        }
        ...
        textTV.setText(marketPost.getDescription());
